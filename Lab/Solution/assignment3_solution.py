...
class Enemy:
    ...
    def respawn(self, value=None):
        ...
        self.speed = random.uniform(0.05, .5)
        self.scale = 1.0
...
def draw_gun():
    ...
    # Align gun with the chest properly
...
def update_game():
    ...
    for bullet in bullets:
        ...
        if bullet.is_alive():
            ...
            # Count missed bullets - only if the bullet wasn't marked as hitting an enemy
            # and we're not in cheat mode
...
def reset_game():
    ...
    global cheat_mode, auto_camera, follow_camera
